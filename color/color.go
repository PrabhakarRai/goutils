// Color package provides functions to change the color of console text.
// Under windows platform, the Console API is used.
// Under other systems, ANSI text mode is used.
// https://github.com/daviddengcn/go-colortex
